...
description: "Complete API documentation for Mifumo SMS platform"
---

<div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '40px', padding: '20px 0' }}>
  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
    <img src="/logo/light.png" alt="Mifumo SMS API Logo" style={{ width: '80px', height: '80px', flexShrink: 0 }} />
    
  </div>
  <div>
    <h1 style={{ margin: 0, fontSize: '2.5rem', fontWeight: 'bold', lineHeight: '1.2' }}>Mifumo SMS API</h1>
    <p style={{ margin: '8px 0 0 0', fontSize: '1.2rem', color: '#666', fontWeight: '400' }}>Complete API documentation for Mifumo SMS platform</p>
  </div>
</div>
...
<Columns cols={2}>
  ...
  <Card
    title="Send SMS"
    icon="message"
    href="/api-reference/sms-operations/send-sms"
  >
  ...
  <Card
    ...
    icon="users"
    href="/api-reference/contact-management/list-contacts"
  >
  ...
  <Card
    title="Campaigns"
    icon="megaphone"
    href="/api-reference/campaign-management/list-campaigns"
  >
  ...
  <Card
    title="Templates"
    icon="file-text"
    href="/api-reference/template-management/list-templates"
  >
  ...
  <Card
    title="Billing"
    icon="credit-card"
    href="/api-reference/billing-payments/sms-packages"
  >
